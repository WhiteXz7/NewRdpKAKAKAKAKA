...
- **Mongóis (lamellar):** elmo cônico (duulga) com nuca lamelar, couraça de lâminas de
  ferro sobre couro.
- **Coreia (Joseon):** lamellar lacada vermelha/ferro, elmo de aba larga com espigão.
...
## Animações geradas (Idle / Walk / Run / Attack / Block)

Cada variante exporta 5 ciclos nos formatos BVH + glTF (quatérnions) + Lua
(KeyframeSequence). No visualizador interativo há: turntable 360°, idle, walk, run e attack.
